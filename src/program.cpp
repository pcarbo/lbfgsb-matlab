...
// -----------------------------------------------------------------
Program::Program(int n, double* x, double* lb, double* ub, int* btype, int m,
		int maxiter, double factr, double pgtol, int iprint) {
	this->n = n;
	this->x = x;
	this->lb = lb;
	this->ub = ub;
...
Program::Program(int n, int m, int maxiter, double factr, double pgtol, int iprint) {
	this->n = n;
	this->x = new double[n];
...
void Program::callLBFGS(const char* cmd) {
	...
	setulb_(&n, &m, x, lb, ub, btype, &f, g, &factr, &pgtol, wa, iwa, task,
